...
<%@page import="kr.puri.entity.Answer"%>
...
<link href="${cpath}/resources/css/Community2.css" rel="stylesheet" />
<html>
<meta charset="EUC-KR">
                     ...
                     <div>
                        <table>
                           <tr>
                              ...
                              <!-- 닉네임 -->
                              <td><input type="text" name="answer_content" size="75px"
                                 style="width: 100%; border: none; margin-right: 1em;"
                                 placeholder="댓글을 입력해주세요."></td>
                              <!-- 댓글 -->
                              <input type="hidden" name="write_seq" value="${bvo.write_seq}">
                              <td style="text-align: left;"><button type="submit">등록</button></td>
                              <!-- 글작성 시 등록 버튼 활성화 -->
                           </tr>
                        </table>
                     </div>
                        ...
                        <div>
                           <table>
                              <tr>
                                 ...
                                 <form action="answerDelete.do?seq=${list.answer_seq}" method="post">
                                 <td><h4 style="text-align: left; margin-bottom: 1em;">${list.answer_content}</h4></td>
                                  <c:if test="${vo.id==list.id}">
                                  <input type="hidden" name="answer_seq" value="${list.answer_seq}">                                 
                                  <input type="hidden" name="write_seq" value="${bvo.write_seq}">
                                  <td style="text-align: right;"><button type="submit">삭제</button></td>
                              </c:if>
