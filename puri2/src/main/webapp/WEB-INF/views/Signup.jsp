               ...
               <div class="row">
                  <div class="col-md-12 mb-3">
                     <label class="bottommargin" for="id">아이디</label> <span
                        ...
                        <button class="checkbtn" type="button" id="idcheck">Check</button><br>
                     </span>
                        <span id="result"></span>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-12 mb-3">
                     <label class="bottommargin" for="id">닉네임</label> <span
                        ...
                        <button class="checkbtn" type="button" id="nickcheck">Check</button>
                     </span>
                  ...
                  $.ajax({
                     ...
                     success:function(data){
                        if(data == 0){      
                           ...
                           $('#nickresult').css('color', 'black');
                           
                        } else{                                          
                           $('#nickresult').html('중복된 닉네임 입니다');
                           $('#nickresult').css('color', 'tomato');
                        }
                     },
                     error : function(){ alert("error"); } 
                  })
