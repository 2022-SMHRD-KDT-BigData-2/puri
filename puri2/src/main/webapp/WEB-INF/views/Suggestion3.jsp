		...
		<div id="center">
         ...
         <fieldset class="fie1">
            ...
            <li>
				...
				<button id="answer1" type="submit" name="question_3" class="btn btn-primary"
					value=1>응!! 아직도 키우는 중이야</button> 
			
			</li>
          <li>
				<button id="answer2" type="submit" name="question_3" class="btn btn-primary"
					value=0>아니 한번도 키워보지 못했어</button> 
					</li>
					</ul>
			</div>
